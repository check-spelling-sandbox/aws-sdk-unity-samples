...
7. For Android - if you are using the same AndroidManifest.xml as shown in [AndroidManifest.xml](https://github.com/amazon-archives/aws-sdk-unity/blob/master/Assets/Plugins/Android/AndroidManifest.xml) do a replace of all occurrences of com.amazonaws.unity to <your package name>. This includes
...
...
 <receiver
        android:name="<package name for broadcast receiever>.GCMBroadcastReceiver"
...
